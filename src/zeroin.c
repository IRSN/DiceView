/* This file is mainly a copy of zeroin.c in base "stats" package of R.
 * Just here to avoids a warning calling .external2("C_zeroin2", ...) in DiceView package
 */
...
/* Wrapper for previous R_zeroin2 function */
