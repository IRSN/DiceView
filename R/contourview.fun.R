...
#' @seealso See \code{\link{sectionview3d}}.
#' @keywords models
#' @examples
...
# #' Alias to contourview.function, for backward compatibility.
# #' @param fun function object to view
# #' @param ... arguments to pass to contourview.function
# #' @seealso contourview.function
# #' @method contourview function
# #' @docType methods
# #' @rdname function-methods
# #' @export
# contourview.fun <- function(fun,...) {
#     contourview.function(model=fun,...)
# }
