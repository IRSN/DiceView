...
# #' Alias to sectionview3d.function, for backward compatibility.
# #' @param fun function object to view
# #' @param ... arguments to pass to sectionview3d.function
# #' @seealso sectionview3d.function
# #' @method sectionview3d function
# #' @docType methods
# #' @rdname function-methods
# #' @export
# sectionview3d.fun <- function(fun,...) {
#     sectionview3d.function(model=fun,...)
# }
