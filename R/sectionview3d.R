...
#' @template sectionview3d-doc
#' @rdname sectionview3d
#' @method sectionview3d WarpKriging
#' @aliases sectionview3d,WarpKriging,WarpKriging-method
#' @export
...
#' }
#'
sectionview3d.WarpKriging <- function(WarpKriging_model,
                                center = NULL,
                                axis = NULL,
                                npoints = 21,
                                col_points = if (!is.null(col)) col else "red",
                                ...
                                engine3d = NULL,
                                ...) {
    sectionview3d_libKriging(WarpKriging_model,center,axis,npoints,
                             col_points=col_points,col_fun=col_fun,col=col,
                             conf_level,conf_fading,bg_fading,
                             mfrow,Xlab, ylab,Xlim,ylim,title,title_sep,add,engine3d,...)
}
