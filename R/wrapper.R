...
## #' @title View the kriging model in a section view.
...
##           )
##
## #' @title View the model in a section view.
...
##           )
##
## #' @title View the function in a section view.
...
#' @title Plot a section view of a kriging or modelPredict model including design points, or a function.
...
## #' @title View the kriging model in a section (3D) view.
## #' @param km kriging model
## #' @importFrom methods setMethod
...
##           )
##
## #' @title View the modelPredict in a section (3D) view.
## #' @param list DiceEval model
## #' @importFrom methods setMethod
...
##           )
##
## #' @title View the function in a section (3D) view.
## #' @param function function, taken as model
## #' @importFrom methods setMethod
...
## #' @title View the kriging model in a contour (2D) view.
## #' @param km kriging model
## #' @importFrom methods setMethod
...
##           )
##
## #' @title View the modelPredict in a contour (2D) view.
## #' @param list DiceEval model
## #' @importFrom methods setMethod
...
##           )
##
## #' @title View the function in a contour (2D) view.
## #' @param function function, taken as model
## #' @importFrom methods setMethod
...
#' @title Plot a contour view of a kriging or modelPredict model including design points, or a function.
